...
interface BlsAccountRegistryInterface extends ethers.utils.Interface {
  ...
  events: {
    "PubkeyRegistered(uint256[4],uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "PubkeyRegistered"): EventFragment;
}

export class BlsAccountRegistry extends Contract {
  ...
  functions: {
    ...
    "exists(uint256,uint256[4],bytes32[31])"(
      pubkeyID: BigNumberish,
      pubkey: BigNumberish[],
      witness: BytesLike[],
      overrides?: CallOverrides
  ...
  filters: {
    PubkeyRegistered(pubkey: null, pubkeyID: null): EventFilter;
  };
  ...
  estimateGas: {
    ...
    register(pubkey: BigNumberish[], overrides?: Overrides): Promise<BigNumber>;
