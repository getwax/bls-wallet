...
interface FrontendCreate2TransferInterface extends ethers.utils.Interface {
  functions: {
    ...
    "decodeWithPub(bytes)": FunctionFragment;
    "decompress(bytes)": FunctionFragment;
    "encode(tuple)": FunctionFragment;
    "encodeWithPub(tuple)": FunctionFragment;
    "process(bytes32,bytes,uint256,tuple,tuple)": FunctionFragment;
    "signBytes(bytes)": FunctionFragment;
    "validate(bytes,uint256[2],uint256[4],uint256[4],bytes32)": FunctionFragment;
    "validateAndApply(bytes,bytes)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "decodeWithPub",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "encodeWithPub",
    values: [
      {
        txType: BigNumberish;
        fromIndex: BigNumberish;
        toPubkey: BigNumberish[];
        amount: BigNumberish;
        fee: BigNumberish;
        nonce: BigNumberish;
      }
...
export class FrontendCreate2Transfer extends Contract {
  ...
  interface: FrontendCreate2TransferInterface;
  ...
  functions: {
    ...
    validate(
      encodedTx: BytesLike,
      signature: BigNumberish[],
      pubkeySender: BigNumberish[],
      pubkeyReceiver: BigNumberish[],
      domain: BytesLike,
      overrides?: CallOverrides
    ): Promise<{
      0: void;
    ...
    "validate(bytes,uint256[2],uint256[4],uint256[4],bytes32)"(
      encodedTx: BytesLike,
      signature: BigNumberish[],
      pubkeySender: BigNumberish[],
      pubkeyReceiver: BigNumberish[],
