...
interface TestRollupInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setMinGasLeft(uint256)": FunctionFragment;
    "submitDeposits(bytes32)": FunctionFragment;
    "submitDummyBatch()": FunctionFragment;
    "testRollback(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setMinGasLeft",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "submitDummyBatch",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testRollback",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class TestRollup extends Contract {
  ...
  functions: {
    ...
    "setMinGasLeft(uint256)"(
      minGasLeft: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    submitDeposits(
      depositSubTreeRoot: BytesLike,
      overrides?: PayableOverrides
    ): Promise<ContractTransaction>;

    "submitDeposits(bytes32)"(
      depositSubTreeRoot: BytesLike,
      overrides?: PayableOverrides
    ): Promise<ContractTransaction>;
  ...
  submitDummyBatch(overrides?: PayableOverrides): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    submitDummyBatch(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    submitDummyBatch(overrides?: PayableOverrides): Promise<BigNumber>;
