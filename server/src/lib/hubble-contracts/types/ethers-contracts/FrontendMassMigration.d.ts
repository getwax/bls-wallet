...
interface FrontendMassMigrationInterface extends ethers.utils.Interface {
  functions: {
    ...
    "process(bytes32,bytes,uint256,tuple)": FunctionFragment;
...
export class FrontendMassMigration extends Contract {
  ...
  interface: FrontendMassMigrationInterface;
  ...
  functions: {
    ...
    "process(bytes32,bytes,uint256,tuple)"(
      stateRoot: BytesLike,
      encodedTx: BytesLike,
      tokenID: BigNumberish,
      from: {
