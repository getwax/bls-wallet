...
describe("Signer contract interaction tests", function () {
  ...
  describe("ERC20", async function () {
    ...
    it("calls transfer() successfully after instantiating Contract class with BlsSigner", async function () {
      const ERC20 = new ethers.Contract(
        mockERC20.address,
        mockERC20.interface,
        blsSigners[0],
    ...
    it("contract factory connects and reconnects to new signer", async function () {
